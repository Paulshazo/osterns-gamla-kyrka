...
const translations = {
    sv: {
        ...
        "page.income.edit_title":      "Redigera intäkt",
        "page.income.confirm_delete":  "Är du säker att du vill radera den här intäkten?",
        "page.income.error_amount":    "Fyll i minst en summa.",
        ...
        "page.expenses.edit_title":  "Redigera utgift",
        "page.expenses.confirm_delete":"Är du säker att du vill radera den här utgiften?",
        "page.expenses.error_amount":"Fyll i minst en summa.",
        ...
        "form.family.fee_auto_hint":      "Fylls i automatiskt från personnumret: 100 kr under 18 år, 200 kr från 18 år.",
        "form.family.fee_exempt":         "Betalar inte (kyrkotjänst)",
        "form.family.fee_exempt_hint":    "Nollar avgiften för den som gör tjänst i kyrkan.",
        ...
        "form.payment.est_monthly":       "Månadsavgift",
        ...
        "form.payment.valid_desc":        "Medlemskapet är giltigt till detta datum.",
        ...
        // Documents
        "page.documents.title":           "Viktiga dokument",
        "page.documents.desc":            "Ladda upp och förvara viktiga dokument för organisationen. Administratörer kan ladda upp, ladda ner och radera. Övriga användare kan läsa dokument i webbläsaren.",
        "page.documents.view":            "Visa",
        "page.documents.view_loading":    "Öppnar dokument...",
        "page.documents.preview_unavailable": "Förhandsvisning stöds inte för den här filtypen. Administratörer kan ladda ner filen.",
        "page.documents.upload":          "Ladda upp dokument",
        "page.documents.uploading":       "Laddar upp...",
        "page.documents.upload_success":  "Dokumentet har laddats upp.",
        "page.documents.download":        "Ladda ner",
        "page.documents.empty":           "Inga dokument uppladdade än.",
        "page.documents.max_size":        "Max 20 MB per fil.",
        "page.documents.read_only_hint":  "Du kan läsa dokument här i webbläsaren. Endast administratörer kan ladda upp, ladda ner eller radera.",
        "page.documents.error_view":      "Kunde inte öppna dokumentet.",
        "page.documents.col_name":        "Filnamn",
        "page.documents.col_size":        "Storlek",
        "page.documents.col_date":        "Uppladdad",
        "page.documents.confirm_delete":  "Radera \"{name}\"? Detta kan inte ångras.",
        "page.documents.delete_success":  "Dokumentet har raderats.",
        "page.documents.no_org":          "Välj en organisation för att se dokument.",
        "page.documents.error_load":      "Kunde inte ladda dokument.",
        "page.documents.error_upload":    "Uppladdningen misslyckades.",
        "page.documents.error_download":  "Kunde inte ladda ner filen.",
        "page.documents.error_delete":    "Kunde inte radera dokumentet.",
        "page.documents.error_size":      "Filen måste vara mellan 1 byte och 20 MB.",
        ...
        "page.settings.desc_password":   "Byt ditt lösenord.",
        "page.settings.password_section":"Byta mitt lösenord",
        "page.settings.password_current":"Nuvarande lösenord",
        "page.settings.password_new":    "Nytt lösenord",
        "page.settings.password_repeat": "Upprepa nytt lösenord",
        "page.settings.password_hint":   "Minst 8 tecken. Skriv det nya lösenordet två gånger så att de matchar.",
        "page.settings.password_save":   "Byt lösenord",
        "page.settings.password_saving": "Byter lösenord...",
        "page.settings.password_saved":  "Lösenordet är bytt.",
        "page.settings.password_mismatch":"De nya lösenorden matchar inte.",
    ...
    en: {
        ...
        "page.income.edit_title":      "Edit income",
        "page.income.confirm_delete":  "Are you sure you want to delete this income entry?",
        "page.income.error_amount":    "Enter at least one amount.",
        ...
        "page.expenses.edit_title":   "Edit expense",
        "page.expenses.confirm_delete":"Are you sure you want to delete this expense entry?",
        "page.expenses.error_amount": "Enter at least one amount.",
        ...
        "form.family.fee_auto_hint":      "Filled automatically from the personal number: 100 SEK under 18, 200 SEK from 18.",
        "form.family.fee_exempt":         "Does not pay (church service)",
        "form.family.fee_exempt_hint":    "Sets this person's fee to 0 for those who serve in the church.",
        ...
        "form.payment.est_monthly":       "Monthly fee",
        ...
        // Documents
        "page.documents.title":           "Important documents",
        "page.documents.desc":            "Upload and store important documents for the organisation. Administrators can upload, download, and delete. Other users can read documents in the browser.",
        "page.documents.view":            "View",
        "page.documents.view_loading":    "Opening document...",
        "page.documents.preview_unavailable": "Preview is not supported for this file type. Administrators can download the file.",
        "page.documents.upload":          "Upload document",
        "page.documents.uploading":       "Uploading...",
        "page.documents.upload_success":  "Document uploaded.",
        "page.documents.download":        "Download",
        "page.documents.empty":           "No documents uploaded yet.",
        "page.documents.max_size":        "Max 20 MB per file.",
        "page.documents.read_only_hint":  "You can read documents here in the browser. Only administrators can upload, download, or delete.",
        "page.documents.error_view":      "Could not open the document.",
        "page.documents.col_name":        "File name",
        "page.documents.col_size":        "Size",
        "page.documents.col_date":        "Uploaded",
        "page.documents.confirm_delete":  "Delete \"{name}\"? This cannot be undone.",
        "page.documents.delete_success":  "Document deleted.",
        "page.documents.no_org":          "Select an organisation to view documents.",
        "page.documents.error_load":      "Could not load documents.",
        "page.documents.error_upload":    "Upload failed.",
        "page.documents.error_download":  "Could not download the file.",
        "page.documents.error_delete":    "Could not delete the document.",
        "page.documents.error_size":      "File must be between 1 byte and 20 MB.",
        ...
        "page.settings.desc_password":   "Change your password.",
        "page.settings.password_section":"Change my password",
        "page.settings.password_current":"Current password",
        "page.settings.password_new":    "New password",
        "page.settings.password_repeat": "Repeat new password",
        "page.settings.password_hint":   "At least 8 characters. Enter the new password twice so they match.",
        "page.settings.password_save":   "Change password",
        "page.settings.password_saving": "Changing password...",
        "page.settings.password_saved":  "Password updated.",
        "page.settings.password_mismatch":"The new passwords do not match.",
