...
const translations = {
    sv: {
        ...
        "page.documents.desc":            "Ladda upp och förvara viktiga dokument för organisationen. Administratörer kan ladda upp, ladda ner och radera. Övriga användare kan endast läsa och ladda ner.",
        ...
        "page.documents.read_only_hint":  "Du har läsbehörighet. Endast administratörer kan ladda upp eller radera dokument.",
    ...
    en: {
        ...
        "page.documents.desc":            "Upload and store important documents for the organisation. Administrators can upload, download, and delete. Other users can only view and download.",
        ...
        "page.documents.read_only_hint":  "You have read-only access. Only administrators can upload or delete documents.",
